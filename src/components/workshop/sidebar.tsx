...
export function Sidebar({ persona, user }: { persona: DemoPersona; user?: DemoUserInfo | null }) {
  ...
  return (
    ...
    >
      <Link href="/workshop/dashboard" className={cn("flex items-center h-16 border-b border-sidebar-border", expanded ? "gap-2.5 px-5 mb-3" : "gap-0 justify-center")}>
      ...
      {user && (
        <div className={cn("flex items-center h-16 border-b border-sidebar-border", expanded ? "gap-3 px-5 mb-3" : "gap-0 justify-center")}>
