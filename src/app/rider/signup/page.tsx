    ...
    <div className="flex justify-center px-4 py-4 relative overflow-hidden">
      <div className="w-full max-w-sm relative">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold tracking-tight">Join D&Z Rider</h1>
          <p className="text-sm text-muted-foreground">Create your account — your bikes & service in one place</p>
        </div>
        ...
        <p className="mt-4 text-center text-xs text-muted-foreground">
          Already have an account? <a href="/rider/login" className="text-primary hover:underline">Sign in</a>
        </p>
      </div>
    </div>
  );
