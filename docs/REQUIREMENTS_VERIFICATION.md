...
| 3 | 网站与线索捕获 | §5 + §6 | 46 | ✅ 补齐完成|
| 4 | 销售管道/跟进任务/试驾 | §7-9 | 52 | ✅ 补齐完成|
| 5 | 客户 CRM/车辆登记/时间线 | §10-11 + §29 | 74 | ✅ 补齐完成|
| 6 | 在线服务预约 | §12 | 35 | ✅ 补齐完成|
| 7 | 工单运营/技师管理/服务历史 | §13-15 | 72 | ✅ 补齐完成|
| 8 | 零件与库存 | §16 | 34 | ✅ 补齐完成|
| 9 | 提醒/自动化/消息 | §17-19 | 69 | ✅ 补齐完成|
| 10 | 忠诚度/推荐/营销活动 | §20-22 | 55 | ✅ 补齐完成|
| 11 | 仪表盘/营收/分析/多分支 | §4 + §23-25 | 111 | ✅ 补齐完成|
| 12 | 搜索/通知/导入导出/文件 | §26 + §28 + §31-32 + §37 | 55 | ✅ 补齐完成|
| 13 | AI-Native CRM | §27 | 33 | ✅ 补齐完成|
| 14 | API/集成/审计/安全/隐私 | §33-36 | 57 | ✅ 补齐完成|
| 15 | 移动UX/性能/可靠性/管理配置/导航 | §38-41 + §47 | 60 | ✅ 补齐完成|
| 16 | 端到端工作流 + V1 完成定义 | §42-46 | 40 | ✅ 补齐完成|
...
| LEAD-002 | WhatsApp e | ✅ 补齐完成|  |
| LEAD-003 | Walk-i | ✅ 补齐完成|  |
| LEAD-004 | Pho | ✅ 补齐完成|  |
| LEAD-005 | Social media leads must be impo | ✅ 补齐完成|  |
| LEAD-006 | Leads must co | ✅ 补齐完成|  |
| LEAD-007 | Leads must | ✅ 补齐完成|  |
| LEAD-008 | Leads must | ⏳ |  |
| LEAD-009 | Leads must | ⏳ |  |
...
| ID | 需求 | 状态 | 证据/备注 |
|---|---|---|---|
| BOOK-001 | Custome | ���������✅ 防超卖校验（bookedCount>=max 拒绝）|  |
| BOOK-002 | Booki | ⏳ |  |
| BOOK-003 | Custome | ⏳ |  |
| BOOK-004 | Custome | ⏳ |  |
| BOOK-005 | Custome | ⏳ |  |
...
| ID | 需求 | 状态 | 证据/备注 |
|---|---|---|---|
| INV-001 | Stock must be t | 🟡 分支对比报表未做（stock 按分支查）|  |
...
| ID | 需求 | 状态 | 证据/备注 |
|---|---|---|---|
| AI-001 | AI must be able to summa | ����✅ CRUD 独立于 AI|  |
| AI-002 | AI must ide | ⏳ |  |
| AI-003 | AI must ide | ⏳ |  |
