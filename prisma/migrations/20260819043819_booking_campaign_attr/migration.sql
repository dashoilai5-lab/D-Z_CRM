...
INSERT INTO "new_Booking" ("branchId", "createdAt", "customerId", "date", "id", "jobId", "motorcycleId", "notes", "serviceType", "source", "status", "timeSlot", "updatedAt") SELECT "branchId", "createdAt", "customerId", "date", "id", "jobId", "motorcycleId", "notes", "serviceType", "source", "status", "timeSlot", "updatedAt" FROM "Booking";
DROP TABLE "Booking";
